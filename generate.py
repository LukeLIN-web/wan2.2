...
EXAMPLE_PROMPT = {
    ...
    "v2v-14B": {
        "prompt": None,  # Will be generated by VLM
...
def _validate_args(args):
    ...
    if args.video is None and "video" in EXAMPLE_PROMPT[args.task]:
    ...
    if args.task in ["v2v-14B", "v2v-5B"]:
        assert args.video is not None, "Please specify the video path for v2v using --video."
...
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to input video for v2v task.")
    parser.add_argument(
        "--vlm_device",
        type=str,
        default=None,
